...
//	}
//
//	if err = h.doEditOwner(h.ctx, &req[0], apiResp); err != nil {
...
//
//	if err = h.doEditOwner(ctx.Request.Context(), &req, &apiResp); err != nil {
//		log.Error("doEditOwner err:", err.Error(), funcName, clientIp, ctx.Request.Context())
//	}
//
//	ctx.JSON(http.StatusOK, apiResp)
//}
//
//func (h *HttpHandle) doEditOwner(ctx context.Context, req *ReqEditOwner, apiResp *api_code.ApiResp) error {
