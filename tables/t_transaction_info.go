...
type TableTransactionInfo struct {
	...
	AlgId          common.DasAlgorithmId    `json:"alg_id" gorm:"column:alg_id;"`
	SubAlgId       common.DasSubAlgorithmId `json:"sub_alg_id" gorm:"column:sub_alg_id;"`
...
const (
	...
	ActionAuctionRefundCapacity     TxAction = 31
...
func FormatTxAction(action string) TxAction {
	...
	case common.DasActionBidExpiredAccountAuction:
		return ActionAuctionRefundCapacity
	}
