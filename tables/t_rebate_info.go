...
type TableRebateInfo struct {
	...
	InviteeAlgId     common.DasAlgorithmId    `json:"invitee_alg_id" gorm:"column:invitee_alg_id;"`
	InviteeSubAlgId  common.DasSubAlgorithmId `json:"invitee_sub_alg_id" gorm:"column:invitee_sub_alg_id;"`
	RewardType       int                      `json:"reward_type" gorm:"column:reward_type"`
	...
	InviterAlgId     common.DasAlgorithmId    `json:"inviter_alg_id" gorm:"column:inviter_alg_id;"`
	InviterSubAlgId  common.DasSubAlgorithmId `json:"inviter_sub_alg_id" gorm:"column:inviter_sub_alg_id;"`
