...
const (
	...
	SearchStatusOnUpgradeDidCell     SearchStatus = 20
)
...
func (t *TableAccountInfo) FormatAccountStatus() SearchStatus {
	...
	case AccountStatusOnUpgrade:
		return SearchStatusOnUpgradeDidCell
	default:
...
const (
	...
	CategoryMainAccount                      Category = 1 // Upgraded DIDs
	CategorySubAccount                       Category = 2 // Second-Level DIDs
